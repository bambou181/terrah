              ...
              <div class="row ">
                <div class=" col-12 col-lg-5 mb-4  ">
                  <form action="index.html">
                    <input type="text" class="form-control form-control-lg border-0" placeholder="Aire" />
                  </form>
                </div>
                <div class="col-12 col-lg-5 mb-4">
                  <form action="index.html">
                    <input type="text" class="form-control form-control-lg border-0" placeholder="Lieu" />
                  </form>
                </div>
                <div class="col-2">
            ...
            <div class="accordion-item">
              ...
              <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                ...
                <div class="accordion-body">
                  En effet, notre équipe travaille dur enfin de mettre à votre disposition des terrains en vente
                  </div>
              </div>
            </div>
            <div class="accordion-item">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-3">
                      ...
                      <div class="icon-button">
                        <a href="property-details.html"><i class="bi bi-calendar"></i> Schedule a visit</a>
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6">
          <div class="item">
            <a href="property-details.html"><img src="{{ asset('/img/property-01.jpg') }}" alt=""></a>
